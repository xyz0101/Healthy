...
<head>
    ...
    <link href="css1/bootstrap.css" rel='stylesheet' type='text/css' />
        <link href="css1/know.css" rel='stylesheet' type='text/css' />
        ...
        <div class="shop_top">
            <div class="container">
             <div class="list_title" id="list_title_id"><h3>器材百科</h3> </div> <div class="list_a"><a href="">更多器材</a> </div>
				...
				<c:forEach items="${requestScope.equipment }"  var="equipment" varStatus="status" begin="0" end="3">
                <div class="col-md-3 shop_box" >
                    <a href="${equipment.equipmentUrl }">
                        ...
                        </a><h3 style="margin-left:80px"><a href="${equipment.equipmentUrl }"> ${equipment.equipmentName }</a></h3>
 			    ...
 			    <div class="_br"></div>
 			 <div class="container">
			 <div class="list_title" id="list_title_id"><h3>健身计划推荐</h3> </div> <div class="list_a"><a href="">查看更多</a> </div>
                <div class="clear"></div>
                  <div class="_br1"></div>
            
				<c:forEach items="${requestScope.plane }"  var="plane" varStatus="status" begin="0" end="6">
                <div class="col-md-3 shop_box" >
                    <a href="${plane.planeUrl }">
                        <img src="${plane.planeImg }" class="img-responsive" alt="">
                    </a><div class="shop_desc">
                        <a href="${plane.planeUrl }">

                        </a><h3 style="margin-left:80px"><a href="${plane.planeUrl }"> ${plane.planeTitle }</a></h3>
                   ...
                   <div class="_br"></div>
                <div class="container">
 			 <div class="list_title" id="list_title_id"><h3>人体肌肉百科</h3> </div> <div class="list_a"><a href="">查看更多</a> </div>
                <div class="clear"></div>
                  <div class="_br1"></div>
            
				<c:forEach items="${requestScope.muscle }"  var="muscle" varStatus="status" begin="0" end="6">
                <div class="col-md-3 shop_box" >
                    <a href="${muscle.muscleUrl }">
                        <img src="${muscle.muscleImg }" class="img-responsive" alt="">
                    </a><div class="shop_desc">
                        <a href="${muscle.muscleUrl }">

                        </a><h3 style="margin-left:80px"><a href="${muscle.muscleUrl }"> ${muscle.muscleName }</a></h3>
